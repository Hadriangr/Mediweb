    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('P', 'Paciente'), ('D', 'Doctor'), ('A', 'Administrador')], default='P', max_length=1)),
        ...
        migrations.CreateModel(
            name='Doctor',
            fields=[
                ('usuario_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='Medic.usuario')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Medic.usuario')),
                ('receta_medica', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Medic.recetamedica')),
            ],
        ),
    ]
